...
class Config(object):
	...
	def default_conf(self):
		...
		self.conf.set("HTML","description","The website description")
		self.conf.set("HTML","footer","The copyright information")
		self.conf.set("HTML","template","default")
		self.conf.set("HTML","baseaddress","http://www.feed.fi")
